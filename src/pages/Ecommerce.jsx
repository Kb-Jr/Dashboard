      ...
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        <div className='flex m-3 justify-center flex-wrap gap-1 items-center'>
          {earningData.map((item) => {
            return (
              <div key={crypto.randomUUID()} className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-2xl'>
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='pr-10 m-4'>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>N48,438</span>
                </p>
            ...
            <div>
              <Stacked width="320px" height="360px" borderRadius="10px" />
            </div>
          </div>
        </div>
      </div>
